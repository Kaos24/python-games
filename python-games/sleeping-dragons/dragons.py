...
def draw_counters(eggs_collected, lives):
    ...
    screen.draw.text(str(eggs_collected), fontsize=40, pos=(30, HEIGHT - 27), color=FONT_COLOUR)
    screen.blit("life-count", (60, HEIGHT - 30))
    screen.draw.text(str(lives), fontsize=40, pos=(90, HEIGHT - 27), color=FONT_COLOUR)
